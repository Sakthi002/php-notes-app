                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <textarea id="body"
                                                  ...
                                                  rows="3"
                                                  class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?= $note['body'] ?></textarea>
...
<!--                    </form>-->
                    <div class="p-2 flex items-center justify-end gap-x-2">
